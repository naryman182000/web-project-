                  ...
                  <div class="col-md-6">
                    <div class="slider_item-detail">
                      ...
                      <div>
                        ...
                        <div class="d-flex">
                          <div>
                            <a href="about.html" class="read-btn">
                          ...
                          <div class="ml-3">
                            <a href="service.html" class="quote-btn">
...
$car_ID= $_POST['car_ID'];
$licence_city= $_POST['licence_city'];
$hight_permession= $_POST['hight_permession'];
...
if($conn->connect_error){
    ...
    $stmt = $conn->prepare("insert into cars (FullName,Email,phone_Number,birth_date,National_ID,gender,
    car_licence_number, car_licence_date,password,car_model,licence_Number,licence_date,car_ID,licence_city,hight_permession) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
    $stmt->bind_param("ssisissssssssss", $FullName , $Email , $phone_Number,$birth_date,$National_ID,$gender,
    $car_licence_number,$car_licence_date, $password,$car_model,$licence_Number, $licence_date,$car_ID,$licence_city,$hight_permession);
    $stmt->execute();
    $stmt->close();
    $conn->close();
}
