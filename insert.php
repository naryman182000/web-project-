                    ...
                    <div class="slider_item-detail">
                      ...
                      <div>
                        ...
                        <div class="d-flex">
                          ...
                          <div class="ml-3">
                            <a href="sign_in.php" class="quote-btn">
...
if($conn->connect_error){
    ...
    $stmt = $conn->prepare("insert into customers (firstName,lastName,email,phone_Number,password) values(?,?,?,?,?)");
    $stmt->bind_param("sssis", $firstName , $lastName , $email , $phone_Number, $password);
    $stmt->execute();
