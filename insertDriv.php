...
if($conn->connect_error){
    ...
    $stmt = $conn->prepare("insert into drivers(FullName,email,phone_Number,password,birth_date,licence_Number,licence_date,National_ID,gender
    ) values(?,?,?,?,?,?,?,?,?)");
    $stmt->bind_param("ssissssis", $FullName , $email , $phone_Number,$password,$birth_date,$licence_Number, $licence_date,$National_ID,$gender
    );
    $stmt->execute();
    $stmt->close();
    $conn->close();
